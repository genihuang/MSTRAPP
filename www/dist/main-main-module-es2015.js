 ...
 * @type {?}
 */
const NX_DATE_LOCALE = new _angular_core__WEBPACK_IMPORTED_MODULE_13__["InjectionToken"]('nx-date-locale');
 ...
 */
/** @type {?} */
const NX_DATE_FORMATS = new _angular_core__WEBPACK_IMPORTED_MODULE_13__["InjectionToken"]('nx-date-formats');
 ...
 */
/** @type {?} */
const NX_DATE_LOCALE_PROVIDER = { provide: NX_DATE_LOCALE, useExisting: _angular_core__WEBPACK_IMPORTED_MODULE_13__["LOCALE_ID"] };
 ...
 * @type {?}
 */
const NX_DATEPICKER_SCROLL_STRATEGY = new _angular_core__WEBPACK_IMPORTED_MODULE_13__["InjectionToken"]('nx-datepicker-scroll-strategy');
/**
 * \@docs-private
 * @param {?} overlay
 * @return {?}
...
/** @type {?} */
const DATEPICKER_DEFAULT_OPTIONS = new _angular_core__WEBPACK_IMPORTED_MODULE_13__["InjectionToken"]('DATEPICKER_DEFAULT_OPTIONS');
/**
 * \@docs-private
...
class NxDatepickerComponent {
    ...
    _createPopup() {
         ...
         * @return {?}
         */
        event => event.keyCode === _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_11__["ESCAPE"])))).subscribe((/**
         * @return {?}
         */
        () => this.close()));
    }
...
class NxDatepickerToggleComponent {
    ...
    _watchStateChanges() {
        /** @type {?} */
        const datepickerDisabled = this.datepicker ? this.datepicker._disabledChange : Object(rxjs__WEBPACK_IMPORTED_MODULE_14__["of"])();
        /** @type {?} */
...
class NxMenuComponent {
    ...
    set open(value) {
        /** @type {?} */
        const open = Object(_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_3__["coerceBooleanProperty"])(value);
        if (open !== this._open) {
            this._open = open;
            this._changeDetectorRef.markForCheck();
        }
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ɵa", function() { return NxTabGroupBase; });
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js");
...
/* harmony import */ var _allianz_ngx_ndbx_accordion__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @allianz/ngx-ndbx/accordion */ "./node_modules/@allianz/ngx-ndbx/fesm2015/allianz-ngx-ndbx-accordion.js");
...
NxTabComponent.ctorParameters = () => [
    ...
    { type: NxTabGroupBase, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["Inject"], args: [NxTabGroupBase,] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["Optional"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["Host"] }] }
];
NxTabComponent.propDecorators = {
    label: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["Input"] }],
    _implicitContent: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["ViewChild"], args: [_angular_core__WEBPACK_IMPORTED_MODULE_6__["TemplateRef"],] }]
};
...
NxTabBodyComponent.propDecorators = {
    content: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["Input"] }],
    active: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["Input"] }],
    portalOutlet: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["ViewChild"], args: [_angular_cdk_portal__WEBPACK_IMPORTED_MODULE_1__["CdkPortalOutlet"],] }]
};
...
NxTabLabelDirective.decorators = [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["Directive"], args: [{ selector: '[nxTabLabel]' },] }
];
/** @nocollapse */
...
NxTabHeaderComponent.propDecorators = {
    selectedIndex: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["Input"] }],
    autoselect: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["Input"] }],
    selectFocusedIndex: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["Output"] }],
    indexFocused: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["Output"] }],
    labels: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["ContentChildren"], args: [NxTabLabelDirective,] }]
};
...
class NxTabGroupComponent {
    ...
    _subscribeToTabLabels() {
        ...
        this._tabLabelSubscription = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["merge"])(...this.tabs.map((/**
         * @param {?} tab
         * @return {?}
         */
...
NxTabGroupComponent.propDecorators = {
    tabs: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["ContentChildren"], args: [NxTabComponent,] }],
    tabBodyChildren: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["ViewChildren"], args: [NxTabBodyComponent,] }],
    tabHeader: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["ViewChild"], args: ['tabHeader',] }],
    panels: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["ViewChildren"], args: [_allianz_ngx_ndbx_accordion__WEBPACK_IMPORTED_MODULE_3__["NxExpansionPanelComponent"],] }],
    accordion: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["ViewChild"], args: [_allianz_ngx_ndbx_accordion__WEBPACK_IMPORTED_MODULE_3__["NxAccordionDirective"],] }],
    selectedIndex: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["Input"] }],
    negative: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["Input"] }],
    autoselect: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["Input"] }],
    mobileAccordion: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["Input"] }],
    selectedIndexChange: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["Output"] }],
    selectedTabChange: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["Output"] }],
    focusChange: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["Output"] }],
...
class NxTabNavBarComponent {
    ...
    set negative(value) {
        /** @type {?} */
        const newValue = Object(_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_7__["coerceBooleanProperty"])(value);
...
NxTabLinkDirective.ctorParameters = () => [
    { type: NxTabNavBarComponent, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["Optional"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["SkipSelf"] }] }
];
...
NxTabsModule.decorators = [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_6__["NgModule"], args: [{
                imports: [
                    ...
                    _allianz_ngx_ndbx_accordion__WEBPACK_IMPORTED_MODULE_3__["NxAccordionModule"]
                ],
                exports: [
                    NxTabComponent,
                    NxTabGroupComponent,
 ...
 * @template T
 */
class NxTreeComponent extends _angular_cdk_tree__WEBPACK_IMPORTED_MODULE_8__["CdkTree"] {
}
 ...
 * @template T
 */
class NxTreeNodeComponent extends _angular_cdk_tree__WEBPACK_IMPORTED_MODULE_8__["CdkTreeNode"] {
}
 ...
 * @template T
 */
class NxTreeNodeDefDirective extends _angular_cdk_tree__WEBPACK_IMPORTED_MODULE_8__["CdkTreeNodeDef"] {
}
 ...
 * @template T
 */
class NxTreeNodeToggleDirective extends _angular_cdk_tree__WEBPACK_IMPORTED_MODULE_8__["CdkTreeNodeToggle"] {
    constructor() {
        super(...arguments);
...
class NxTreeFlattener {
    ...
    transformFunction(node, level) {
        const { children } = node, rest = Object(tslib__WEBPACK_IMPORTED_MODULE_4__["__rest"])(node, ["children"]);
 ...
 * @template T, F
 */
class NxTreeFlatDataSource extends _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_5__["DataSource"] {
    /**
     * @param {?} treeControl
     * @param {?=} initialData
     */
 ...
 * @template F
 */
class NxFlatTreeControl extends _angular_cdk_tree__WEBPACK_IMPORTED_MODULE_8__["FlatTreeControl"] {
    constructor() {
        super((/**
         * @param {?} node
         * @return {?}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"flexBlock\">\n    <div class=\"fb MenuBlock\">\n        <app-menu></app-menu>\n    </div>\n    <div class=\"fb ContentBlock\">\n        <router-outlet></router-outlet>\n    </div>\n</div>\n");
...
/* harmony import */ var _allianz_ngx_ndbx__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @allianz/ngx-ndbx */ "./node_modules/@allianz/ngx-ndbx/fesm2015/allianz-ngx-ndbx.js");
/* harmony import */ var _allianz_ngx_ndbx_grid__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @allianz/ngx-ndbx/grid */ "./node_modules/@allianz/ngx-ndbx/fesm2015/allianz-ngx-ndbx-grid.js");
/* harmony import */ var _allianz_ngx_ndbx_icon__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @allianz/ngx-ndbx/icon */ "./node_modules/@allianz/ngx-ndbx/fesm2015/allianz-ngx-ndbx-icon.js");
/* harmony import */ var _allianz_ngx_ndbx_menu__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @allianz/ngx-ndbx/menu */ "./node_modules/@allianz/ngx-ndbx/fesm2015/allianz-ngx-ndbx-menu.js");
/* harmony import */ var _allianz_ngx_ndbx_sidebar__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @allianz/ngx-ndbx/sidebar */ "./node_modules/@allianz/ngx-ndbx/fesm2015/allianz-ngx-ndbx-sidebar.js");
/* harmony import */ var _allianz_ngx_ndbx_action__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @allianz/ngx-ndbx/action */ "./node_modules/@allianz/ngx-ndbx/fesm2015/allianz-ngx-ndbx-action.js");
/* harmony import */ var _allianz_ngx_ndbx_tree__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @allianz/ngx-ndbx/tree */ "./node_modules/@allianz/ngx-ndbx/fesm2015/allianz-ngx-ndbx-tree.js");
/* harmony import */ var _allianz_ngx_ndbx_tabs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @allianz/ngx-ndbx/tabs */ "./node_modules/@allianz/ngx-ndbx/fesm2015/allianz-ngx-ndbx-tabs.js");
/* harmony import */ var _allianz_ngx_ndbx_config__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @allianz/ngx-ndbx/config */ "./node_modules/@allianz/ngx-ndbx/fesm2015/allianz-ngx-ndbx-config.js");
/* harmony import */ var _main_routing_module__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./main-routing.module */ "./src/app/main/main-routing.module.ts");
/* harmony import */ var _menu_menu_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./menu/menu.component */ "./src/app/main/menu/menu.component.ts");
/* harmony import */ var _content_content_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./content/content.component */ "./src/app/main/content/content.component.ts");
/* harmony import */ var _main_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./main.component */ "./src/app/main/main.component.ts");
...
MainModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _allianz_ngx_ndbx__WEBPACK_IMPORTED_MODULE_4__["NxButtonModule"],
            _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_3__["ScrollingModule"],
            _allianz_ngx_ndbx_grid__WEBPACK_IMPORTED_MODULE_5__["NxGridModule"],
            _allianz_ngx_ndbx_icon__WEBPACK_IMPORTED_MODULE_6__["NxIconModule"],
            _allianz_ngx_ndbx_menu__WEBPACK_IMPORTED_MODULE_7__["NxMenuModule"],
            _allianz_ngx_ndbx_tree__WEBPACK_IMPORTED_MODULE_10__["NxTreeModule"],
            _allianz_ngx_ndbx_tabs__WEBPACK_IMPORTED_MODULE_11__["NxTabsModule"],
            _allianz_ngx_ndbx_sidebar__WEBPACK_IMPORTED_MODULE_8__["NxSidebarModule"],
            _allianz_ngx_ndbx_action__WEBPACK_IMPORTED_MODULE_9__["NxActionModule"],
            _allianz_ngx_ndbx_config__WEBPACK_IMPORTED_MODULE_12__["NxExpertModule"],
            _main_routing_module__WEBPACK_IMPORTED_MODULE_13__["MainRoutingModule"]
        ]
    })
], MainModule);
...
let MenuService = class MenuService {
    ...
    getSubMenus(code) {
        let objData = JSON.parse(sessionStorage.getItem("object"));
        console.log(code + "_Service");
        console.log(code);
        console.log(objData);
        console.log(objData.filter(menu => menu.web_function == code));
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(objData.filter(menu => menu.web_function == code));
