import { EventEmitter, ChangeDetectorRef, AfterContentInit, OnDestroy, QueryList, OnInit } from '@angular/core';
...
export declare class NxCheckboxComponent implements ControlValueAccessor, OnDestroy, OnInit {
    ...
    constructor(_changeDetectorRef: ChangeDetectorRef, checkboxGroup: NxCheckboxGroupComponent);
    /** @docs-private */
