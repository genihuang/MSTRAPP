...
import { AfterViewInit, ElementRef, EventEmitter, TemplateRef, QueryList, ChangeDetectorRef, OnDestroy } from '@angular/core';
...
export declare class NxAutocompleteComponent implements AfterViewInit, OnDestroy {
    ...
    items: Array<string> | Observable<Array<string>>;
    private _items;
    ...
    readonly options: QueryList<NxAutocompleteOptionComponent>;
    /**
