...
import { Directive, ChangeDetectionStrategy, Component, Input, NgModule } from '@angular/core';
...
var NxFigureComponent = /** @class */ (function () {
    ...
    Object.defineProperty(NxFigureComponent.prototype, "classNames", {
        ...
        function (value) {
            ...
            var _a = __read(this._classNames.match(sizeRegex) || [DEFAULT_SIZE], 1), _b = _a[0], size = _b === void 0 ? null : _b;
            this.size = (/** @type {?} */ (size));
...
export { NxImageModule, NxFigureComponent, NxImageDirective };

//# sourceMappingURL=allianz-ngx-ndbx-image.js.map