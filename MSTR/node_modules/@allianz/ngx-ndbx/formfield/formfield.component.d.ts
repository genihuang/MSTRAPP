...
import { AfterContentChecked, AfterContentInit, OnDestroy, ChangeDetectorRef, ElementRef, QueryList, Renderer2 } from '@angular/core';
...
export declare class NxFormfieldComponent implements AfterContentInit, AfterContentChecked, OnDestroy {
    ...
    constructor(
    /** @docs-private */
    elementRef: ElementRef, renderer: Renderer2, _changeDetectorRef: ChangeDetectorRef, _defaultOptions: FormfieldDefaultOptions);
    /** @docs-private */
    readonly control: NxFormfieldControl<any>;
