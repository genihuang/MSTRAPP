import { DoCheck, ElementRef, OnChanges, OnDestroy, InjectionToken } from '@angular/core';
...
export declare class NxInputDirective implements DoCheck, OnChanges, OnDestroy, NxFormfieldControl<any> {
    ...
    /** @docs-private */
    ngControl: NgControl, _parentForm: NgForm, _parentFormGroup: FormGroupDirective, _errorStateMatcher: ErrorStateMatcher, inputValueAccessor: any);
    /** @docs-private */
