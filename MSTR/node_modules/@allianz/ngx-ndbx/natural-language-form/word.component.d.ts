...
export declare class NxWordComponent implements AfterContentInit, OnDestroy {
    /** @docs-private */
    ...
    _popover: NxPopoverTriggerDirective;
    ...
    constructor(
    /** @docs-private */
    elementRef: ElementRef, _changeDetectorRef: ChangeDetectorRef, _renderer: Renderer2, _overlay: Overlay);
