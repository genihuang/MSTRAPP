(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/coercion'), require('@angular/core'), require('@angular/forms'), require('rxjs'), require('@allianz/ngx-ndbx/base'), require('@allianz/ngx-ndbx/icon')) :
    typeof define === 'function' && define.amd ? define('@allianz/ngx-ndbx/radio-button', ['exports', '@angular/cdk/coercion', '@angular/core', '@angular/forms', 'rxjs', '@allianz/ngx-ndbx/base', '@allianz/ngx-ndbx/icon'], factory) :
    (factory((global.allianz = global.allianz || {}, global.allianz['ngx-ndbx'] = global.allianz['ngx-ndbx'] || {}, global.allianz['ngx-ndbx']['radio-button'] = {}),global.ng.cdk.coercion,global.ng.core,global.ng.forms,global.rxjs,global.allianz['ngx-ndbx'].base,global.allianz['ngx-ndbx'].icon));
}(this, (function (exports,coercion,core,forms,rxjs,base,icon) { 'use strict';
