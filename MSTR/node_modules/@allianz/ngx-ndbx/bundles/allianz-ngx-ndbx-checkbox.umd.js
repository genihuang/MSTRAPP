(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/cdk/coercion'), require('@angular/core'), require('@angular/forms'), require('rxjs'), require('@allianz/ngx-ndbx/icon'), require('@allianz/ngx-ndbx/base')) :
    typeof define === 'function' && define.amd ? define('@allianz/ngx-ndbx/checkbox', ['exports', '@angular/common', '@angular/cdk/coercion', '@angular/core', '@angular/forms', 'rxjs', '@allianz/ngx-ndbx/icon', '@allianz/ngx-ndbx/base'], factory) :
    (factory((global.allianz = global.allianz || {}, global.allianz['ngx-ndbx'] = global.allianz['ngx-ndbx'] || {}, global.allianz['ngx-ndbx'].checkbox = {}),global.ng.common,global.ng.cdk.coercion,global.ng.core,global.ng.forms,global.rxjs,global.allianz['ngx-ndbx'].icon,global.allianz['ngx-ndbx'].base));
}(this, (function (exports,common,coercion,core,forms,rxjs,icon,base) { 'use strict';
...
//# sourceMappingURL=allianz-ngx-ndbx-checkbox.umd.js.map