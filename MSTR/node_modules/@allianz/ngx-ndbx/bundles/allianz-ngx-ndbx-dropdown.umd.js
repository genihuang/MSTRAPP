(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@allianz/ngx-ndbx/icon'), require('@angular/common'), require('@allianz/ngx-ndbx/checkbox'), require('@angular/cdk/a11y'), require('@angular/cdk/collections'), require('@angular/cdk/keycodes'), require('@angular/cdk/overlay'), require('@angular/forms'), require('@allianz/ngx-ndbx/formfield'), require('rxjs'), require('rxjs/operators'), require('@angular/core'), require('@angular/cdk/observers')) :
    typeof define === 'function' && define.amd ? define('@allianz/ngx-ndbx/dropdown', ['exports', '@allianz/ngx-ndbx/icon', '@angular/common', '@allianz/ngx-ndbx/checkbox', '@angular/cdk/a11y', '@angular/cdk/collections', '@angular/cdk/keycodes', '@angular/cdk/overlay', '@angular/forms', '@allianz/ngx-ndbx/formfield', 'rxjs', 'rxjs/operators', '@angular/core', '@angular/cdk/observers'], factory) :
    (factory((global.allianz = global.allianz || {}, global.allianz['ngx-ndbx'] = global.allianz['ngx-ndbx'] || {}, global.allianz['ngx-ndbx'].dropdown = {}),global.allianz['ngx-ndbx'].icon,global.ng.common,global.allianz['ngx-ndbx'].checkbox,global.ng.cdk.a11y,global.ng.cdk.collections,global.ng.cdk.keycodes,global.ng.cdk.overlay,global.ng.forms,global.allianz['ngx-ndbx'].formfield,global.rxjs,global.rxjs.operators,global.ng.core,global.ng.cdk.observers));
}(this, (function (exports,icon,common,checkbox,a11y,collections,keycodes,overlay,forms,formfield,rxjs,operators,core,observers) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NxDropdownComponent = /** @class */ (function (_super) {
        ...
        NxDropdownComponent.propDecorators = {
            ...
            panelBody: [{ type: core.ViewChild, args: ['panelBody',] }],
            ...
            _customClosedDropdownLabel: [{ type: core.ContentChild, args: [NxDropdownClosedLabelDirective,] }],
            _defaultClosedDropdownLabel: [{ type: core.ViewChild, args: ['defaultClosedDropdownLabel',] }],
