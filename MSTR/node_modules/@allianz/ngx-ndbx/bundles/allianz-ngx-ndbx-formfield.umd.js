(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('rxjs/operators'), require('@allianz/ngx-ndbx/utils'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@allianz/ngx-ndbx/formfield', ['exports', '@angular/common', 'rxjs/operators', '@allianz/ngx-ndbx/utils', '@angular/core'], factory) :
    (factory((global.allianz = global.allianz || {}, global.allianz['ngx-ndbx'] = global.allianz['ngx-ndbx'] || {}, global.allianz['ngx-ndbx'].formfield = {}),global.ng.common,global.rxjs.operators,global.allianz['ngx-ndbx'].utils,global.ng.core));
}(this, (function (exports,common,operators,utils,core) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NxFormfieldComponent = /** @class */ (function () {
         ...
         */
            function () {
                ...
                subscription = this._control.stateChanges.pipe(operators.startWith(null)).subscribe(( /**
                 * @return {?}
                 */function () {
                ...
                subscription = this._hintChildren.changes.pipe(operators.startWith(null)).subscribe(( /**
                 * @return {?}
                 */function () {
                    _this._changeDetectorRef.markForCheck();
                }));
                ...
                subscription = this._errorChildren.changes.pipe(operators.startWith(null)).subscribe(( /**
                 * @return {?}
                 */function () {
                    _this._syncDescribedByIds();
                    _this._changeDetectorRef.markForCheck();
        ...
        NxFormfieldComponent.propDecorators = {
            _control: [{ type: core.ContentChild, args: [NxFormfieldControl,] }],
            label: [{ type: core.Input, args: ['nxLabel',] }],
            _labelChild: [{ type: core.ContentChild, args: [NxFormfieldLabelDirective,] }],
    ...
    exports.ɵe = NxFormfieldAppendixDirective;
    exports.ɵa = NxFormfieldHintDirective;
    exports.ɵb = NxFormfieldNoteDirective;
    exports.ɵd = NxFormfieldPrefixDirective;
    exports.ɵc = NxFormfieldSuffixDirective;
