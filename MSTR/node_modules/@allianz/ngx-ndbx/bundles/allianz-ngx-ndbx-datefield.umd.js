(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@allianz/ngx-ndbx/icon'), require('@angular/cdk/a11y'), require('@angular/cdk/platform'), require('@allianz/ngx-ndbx/formfield'), require('@allianz/ngx-ndbx/input'), require('@angular/forms'), require('@angular/cdk/bidi'), require('@angular/cdk/coercion'), require('@angular/cdk/keycodes'), require('@angular/cdk/overlay'), require('@angular/cdk/portal'), require('rxjs/operators'), require('@angular/core'), require('@angular/common'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@allianz/ngx-ndbx/datefield', ['exports', '@allianz/ngx-ndbx/icon', '@angular/cdk/a11y', '@angular/cdk/platform', '@allianz/ngx-ndbx/formfield', '@allianz/ngx-ndbx/input', '@angular/forms', '@angular/cdk/bidi', '@angular/cdk/coercion', '@angular/cdk/keycodes', '@angular/cdk/overlay', '@angular/cdk/portal', 'rxjs/operators', '@angular/core', '@angular/common', 'rxjs'], factory) :
    (factory((global.allianz = global.allianz || {}, global.allianz['ngx-ndbx'] = global.allianz['ngx-ndbx'] || {}, global.allianz['ngx-ndbx'].datefield = {}),global.allianz['ngx-ndbx'].icon,global.ng.cdk.a11y,global.ng.cdk.platform,global.allianz['ngx-ndbx'].formfield,global.allianz['ngx-ndbx'].input,global.ng.forms,global.ng.cdk.bidi,global.ng.cdk.coercion,global.ng.cdk.keycodes,global.ng.cdk.overlay,global.ng.cdk.portal,global.rxjs.operators,global.ng.core,global.ng.common,global.rxjs));
}(this, (function (exports,icon,a11y,platform,formfield,input,forms,bidi,coercion,keycodes,overlay,portal,operators,core,common,rxjs) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     * @type {?}
     */
    var NX_DATE_LOCALE = new core.InjectionToken('nx-date-locale');
    ...
    var NxNativeDateAdapter = /** @class */ (function (_super) {
        ...
        function NxNativeDateAdapter(matDateLocale, platform$$1) {
        ...
        NxNativeDateAdapter.ctorParameters = function () {
            return [
                { type: String, decorators: [{ type: core.Optional }, { type: core.Inject, args: [NX_DATE_LOCALE,] }] },
     ...
     */
    /** @type {?} */
    var NX_DATE_FORMATS = new core.InjectionToken('nx-date-formats');
     ...
     */
    /** @type {?} */
    var NX_DATE_LOCALE_PROVIDER = { provide: NX_DATE_LOCALE, useExisting: core.LOCALE_ID };
    ...
    var NxDatefieldDirective = /** @class */ (function () {
        ...
        Object.defineProperty(NxDatefieldDirective.prototype, "strict", {
             ...
             * @return {?}
             */ function (value) {
                this._strict = coercion.coerceBooleanProperty(value);
        ...
        NxDatefieldDirective.decorators = [
            { type: core.Directive, args: [{
                        ...
                        providers: [
                            ...
                            { provide: input.NX_INPUT_VALUE_ACCESSOR, useExisting: NxDatefieldDirective }
                        ],
                        host: {
        ...
        NxDatefieldDirective.ctorParameters = function () {
            return [
                ...
                { type: NxDateAdapter, decorators: [{ type: core.Optional }] },
                { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [NX_DATE_FORMATS,] }] },
                { type: formfield.NxFormfieldComponent, decorators: [{ type: core.Optional }] }
            ];
        };
        NxDatefieldDirective.propDecorators = {
            datepicker: [{ type: core.Input, args: ['nxDatepicker',] }],
            datefieldFilter: [{ type: core.Input, args: ['nxDatefieldFilter',] }],
            value: [{ type: core.Input }],
            min: [{ type: core.Input, args: ['nxMin',] }],
            max: [{ type: core.Input, args: ['nxMax',] }],
            strict: [{ type: core.Input, args: ['nxStrict',] }],
            parseFormat: [{ type: core.Input, args: ['nxParseFormat',] }],
            displayFormat: [{ type: core.Input, args: ['nxDisplayFormat',] }],
    ...
    var NxCalendarBodyComponent = /** @class */ (function () {
        ...
        NxCalendarBodyComponent.propDecorators = {
            ...
            previousItems: [{ type: core.Input }],
            followingItems: [{ type: core.Input }],
    ...
    var NxMonthViewComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        NxMonthViewComponent.prototype.ngAfterContentInit = /**
         * @return {?}
         */
            function () {
                this._init();
         ...
         * @return {?}
         */
        NxMonthViewComponent.prototype._dateSelected = /**
         * Handles when a new date is selected.
         * @param {?} date
         * @return {?}
         */
         ...
         * @return {?}
         */
        NxMonthViewComponent.prototype._handleCalendarBodyKeydown = /**
         * Handles keydown events on the calendar body when calendar is in month view.
         * @param {?} event
         * @return {?}
         */
         ...
         * @return {?}
         */
        NxMonthViewComponent.prototype._init = /**
         * Initializes this month view.
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        NxMonthViewComponent.prototype._focusActiveCell = /**
         * Focuses the active cell after the microtask queue is empty.
         * @private
         * @return {?}
         */
         ...
         * @return {?}
         */
        NxMonthViewComponent.prototype._createWeekCells = /**
         * Creates NxCalendarCells for the dates in this month.
         * @private
         * @return {?}
         */
         ...
         * @return {?}
         */
        NxMonthViewComponent.prototype._shouldEnableDate = /**
         * Date filter for the month
         * @private
         * @param {?} date
         * @return {?}
         ...
         * @return {?}
         */
        NxMonthViewComponent.prototype._getDateInCurrentMonth = /**
         * Gets the date in this month that the given Date falls on.
         * Returns null if the given Date is in another month.
         * @private
         * @param {?} date
         ...
         * @return {?}
         */
        NxMonthViewComponent.prototype._hasSameMonthAndYear = /**
         * Checks whether the 2 dates are non-null and fall within the same month of the same year.
         * @private
         * @param {?} d1
         * @param {?} d2
         ...
         * @return {?} The given object if it is both a date instance and valid, otherwise null.
         */
        NxMonthViewComponent.prototype._getValidDateOrNull = /**
         * @private
         * @param {?} obj The object to check.
         * @return {?} The given object if it is both a date instance and valid, otherwise null.
         */
         ...
         * @return {?}
         */
        NxMonthViewComponent.prototype._isRtl = /**
         * Determines whether the user has the RTL layout direction.
         * @private
         * @return {?}
         */
         ...
         * @return {?}
         */
        NxMonthViewComponent.prototype._getLastDaysOfPreviousMonth = /**
         * The last days of the previous month that should be displayed
         * in the first row of the calendar.
         * @return {?}
         */
         ...
         * @return {?}
         */
        NxMonthViewComponent.prototype._getFirstDaysOfFollowingMonth = /**
         * The first days of the following month that should be displayed
         * after the days of the current month. After filling up the last
         * row of the current month, additional rows are added, so that a
         * total of 42 days (6 rows/weeks) is displayed.
         ...
         * @return {?}
         */
        NxMonthViewComponent.prototype._getRowOfDays = /**
         * Returns a row with days, beginning with the date of `firstDayInRow`-parameter.
         * The returned row contains `daysCount` elements.
         * @param {?} firstDayInRow
         * @param {?} daysCount
         * @return {?}
         */
            function (firstDayInRow, daysCount) {
                /** @type {?} */
                var nextRow = [];
                /** @type {?} */
                var dateNames = this._dateAdapter.getDateNames();
        ...
        NxMonthViewComponent.propDecorators = {
            ...
            _nxCalendarBody: [{ type: core.ViewChild, args: [NxCalendarBodyComponent,] }]
        };
    ...
    var NxCalendarComponent = /** @class */ (function () {
        ...
        NxCalendarComponent.propDecorators = {
            ...
            monthSelected: [{ type: core.Output }],
            _userSelection: [{ type: core.Output }],
            monthView: [{ type: core.ViewChild, args: [NxMonthViewComponent,] }],
            yearView: [{ type: core.ViewChild, args: [NxYearViewComponent,] }],
            multiYearView: [{ type: core.ViewChild, args: [NxMultiYearViewComponent,] }]
        };
     ...
     * @type {?}
     */
    var NX_DATEPICKER_SCROLL_STRATEGY = new core.InjectionToken('nx-datepicker-scroll-strategy');
    /**
     * \@docs-private
     * @param {?} overlay
     * @return {?}
     */
    function NX_DATEPICKER_SCROLL_STRATEGY_PROVIDER_FACTORY(overlay$$1) {
        return ( /**
         * @return {?}
    ...
    /** @type {?} */
    var DATEPICKER_DEFAULT_OPTIONS = new core.InjectionToken('DATEPICKER_DEFAULT_OPTIONS');
    /**
     * \@docs-private
    ...
    var NxDatepickerContentComponent = /** @class */ (function () {
        ...
        NxDatepickerContentComponent.propDecorators = {
            _calendar: [{ type: core.ViewChild, args: [NxCalendarComponent,] }]
        };
    ...
    var NxDatepickerComponent = /** @class */ (function () {
         ...
         */
            function () {
                ...
                if (!this._calendarPortal) {
                    this._calendarPortal = new portal.ComponentPortal(NxDatepickerContentComponent, this._viewContainerRef);
                }
                if (!this._popupRef) {
                    this._createPopup();
                }
        ...
        NxDatepickerComponent.ctorParameters = function () {
            return [
                ...
                { type: undefined, decorators: [{ type: core.Inject, args: [NX_DATEPICKER_SCROLL_STRATEGY,] }] },
                { type: NxDateAdapter, decorators: [{ type: core.Optional }] },
                { type: bidi.Directionality, decorators: [{ type: core.Optional }] },
    ...
    var NxDatepickerToggleComponent = /** @class */ (function () {
        ...
        NxDatepickerToggleComponent.ctorParameters = function () {
            return [
                { type: NxDatepickerIntl },
                { type: core.ChangeDetectorRef },
                { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [DATEPICKER_DEFAULT_OPTIONS,] }] }
            ];
        };
        NxDatepickerToggleComponent.propDecorators = {
            _customIcon: [{ type: core.ContentChild, args: [NxDatepickerToggleIconComponent,] }],
    ...
    exports.NxDatefieldModule = NxDatefieldModule;
    exports.NX_DATEFIELD_VALUE_ACCESSOR = NX_DATEFIELD_VALUE_ACCESSOR;
    exports.NX_DATEFIELD_VALIDATORS = NX_DATEFIELD_VALIDATORS;
    exports.NxDatepickerInputEvent = NxDatepickerInputEvent;
    exports.NxDatefieldDirective = NxDatefieldDirective;
    exports.NX_DATE_LOCALE_PROVIDER = NX_DATE_LOCALE_PROVIDER;
    exports.NativeDateModule = NativeDateModule;
    exports.NxNativeDateModule = NxNativeDateModule;
    exports.NX_DATE_LOCALE = NX_DATE_LOCALE;
    exports.NxDateAdapter = NxDateAdapter;
    exports.NX_DATE_FORMATS = NX_DATE_FORMATS;
    exports.NxNativeDateAdapter = NxNativeDateAdapter;
    exports.NX_NATIVE_DATE_FORMATS = NX_NATIVE_DATE_FORMATS;
    exports.NxDatepickerIntl = NxDatepickerIntl;
    exports.NX_DATEPICKER_SCROLL_STRATEGY_PROVIDER_FACTORY = NX_DATEPICKER_SCROLL_STRATEGY_PROVIDER_FACTORY;
    exports.NX_DATEPICKER_SCROLL_STRATEGY = NX_DATEPICKER_SCROLL_STRATEGY;
    exports.NX_DATEPICKER_SCROLL_STRATEGY_PROVIDER = NX_DATEPICKER_SCROLL_STRATEGY_PROVIDER;
    exports.DATEPICKER_DEFAULT_OPTIONS = DATEPICKER_DEFAULT_OPTIONS;
    exports.NxDatepickerContentComponent = NxDatepickerContentComponent;
    exports.NxDatepickerComponent = NxDatepickerComponent;
    exports.ɵc = NxCalendarComponent;
    exports.ɵe = NxCalendarBodyComponent;
    exports.ɵb = NxDatepickerToggleComponent;
    exports.ɵa = NxDatepickerToggleIconComponent;
    exports.ɵd = NxMonthViewComponent;
    exports.ɵg = NxMultiYearViewComponent;
    exports.ɵf = NxYearViewComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=allianz-ngx-ndbx-datefield.umd.js.map