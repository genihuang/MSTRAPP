(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@allianz/ngx-ndbx/icon'), require('@angular/common'), require('rxjs/operators'), require('rxjs'), require('@angular/forms'), require('@angular/cdk/collections'), require('@angular/cdk/coercion'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@allianz/ngx-ndbx/circle-toggle', ['exports', '@allianz/ngx-ndbx/icon', '@angular/common', 'rxjs/operators', 'rxjs', '@angular/forms', '@angular/cdk/collections', '@angular/cdk/coercion', '@angular/core'], factory) :
    (factory((global.allianz = global.allianz || {}, global.allianz['ngx-ndbx'] = global.allianz['ngx-ndbx'] || {}, global.allianz['ngx-ndbx']['circle-toggle'] = {}),global.allianz['ngx-ndbx'].icon,global.ng.common,global.rxjs.operators,global.rxjs,global.ng.forms,global.ng.cdk.collections,global.ng.cdk.coercion,global.ng.core));
}(this, (function (exports,icon,common,operators,rxjs,forms,collections,coercion,core) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NxCircleToggleComponent = /** @class */ (function (_super) {
        ...
        NxCircleToggleComponent.propDecorators = {
            ...
            responsive: [{ type: core.Input }],
            disabled: [{ type: core.Input }],
            toggleButton: [{ type: core.ViewChild, args: [NxMobileToggleButtonComponent,] }],
