(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@allianz/ngx-ndbx/icon'), require('@angular/platform-browser'), require('@angular/animations'), require('rxjs'), require('@angular/common'), require('@angular/core'), require('@angular/cdk/a11y')) :
    typeof define === 'function' && define.amd ? define('@allianz/ngx-ndbx/modal', ['exports', '@allianz/ngx-ndbx/icon', '@angular/platform-browser', '@angular/animations', 'rxjs', '@angular/common', '@angular/core', '@angular/cdk/a11y'], factory) :
    (factory((global.allianz = global.allianz || {}, global.allianz['ngx-ndbx'] = global.allianz['ngx-ndbx'] || {}, global.allianz['ngx-ndbx'].modal = {}),global.allianz['ngx-ndbx'].icon,global.ng.platformBrowser,global.ng.animations,global.rxjs,global.ng.common,global.ng.core,global.ng.cdk.a11y));
}(this, (function (exports,icon,platformBrowser,animations,rxjs,common,core,a11y) { 'use strict';
