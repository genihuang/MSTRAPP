(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@allianz/ngx-ndbx/input'), require('@allianz/ngx-ndbx/formfield'), require('@allianz/ngx-ndbx/utils'), require('@angular/cdk/overlay'), require('@allianz/ngx-ndbx/popover'), require('@allianz/ngx-ndbx/dropdown'), require('@angular/cdk/coercion'), require('rxjs'), require('rxjs/operators'), require('@angular/core'), require('@angular/common')) :
  typeof define === 'function' && define.amd ? define('@allianz/ngx-ndbx/natural-language-form', ['exports', '@allianz/ngx-ndbx/input', '@allianz/ngx-ndbx/formfield', '@allianz/ngx-ndbx/utils', '@angular/cdk/overlay', '@allianz/ngx-ndbx/popover', '@allianz/ngx-ndbx/dropdown', '@angular/cdk/coercion', 'rxjs', 'rxjs/operators', '@angular/core', '@angular/common'], factory) :
  (factory((global.allianz = global.allianz || {}, global.allianz['ngx-ndbx'] = global.allianz['ngx-ndbx'] || {}, global.allianz['ngx-ndbx']['natural-language-form'] = {}),global.allianz['ngx-ndbx'].input,global.allianz['ngx-ndbx'].formfield,global.allianz['ngx-ndbx'].utils,global.ng.cdk.overlay,global.allianz['ngx-ndbx'].popover,global.allianz['ngx-ndbx'].dropdown,global.ng.cdk.coercion,global.rxjs,global.rxjs.operators,global.ng.core,global.ng.common));
}(this, (function (exports,input,formfield,utils,overlay,popover,dropdown,coercion,rxjs,operators,core,common) { 'use strict';
  ...
  var NxWordComponent = /** @class */ (function () {
      ...
      */
      ...
      NxWordComponent.propDecorators = {
          _control: [{ type: core.ContentChild, args: [formfield.NxFormfieldControl,] }],
          _errorChildren: [{ type: core.ContentChildren, args: [formfield.NxFormfieldErrorDirective,] }],
          _popover: [{ type: core.ViewChild, args: [popover.NxPopoverTriggerDirective,] }],
          _dropdown: [{ type: core.ContentChild, args: [dropdown.NxDropdownComponent,] }],
