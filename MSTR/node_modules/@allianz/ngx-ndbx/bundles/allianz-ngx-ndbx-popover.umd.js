(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/coercion'), require('@angular/cdk/portal'), require('@angular/platform-browser'), require('rxjs/operators'), require('rxjs'), require('@angular/core'), require('@angular/cdk/overlay'), require('@angular/common'), require('@allianz/ngx-ndbx/icon')) :
    typeof define === 'function' && define.amd ? define('@allianz/ngx-ndbx/popover', ['exports', '@angular/cdk/coercion', '@angular/cdk/portal', '@angular/platform-browser', 'rxjs/operators', 'rxjs', '@angular/core', '@angular/cdk/overlay', '@angular/common', '@allianz/ngx-ndbx/icon'], factory) :
    (factory((global.allianz = global.allianz || {}, global.allianz['ngx-ndbx'] = global.allianz['ngx-ndbx'] || {}, global.allianz['ngx-ndbx'].popover = {}),global.ng.cdk.coercion,global.ng.cdk.portal,global.ng.platformBrowser,global.rxjs.operators,global.rxjs,global.ng.core,global.ng.cdk.overlay,global.ng.common,global.allianz['ngx-ndbx'].icon));
}(this, (function (exports,coercion,portal,platformBrowser,operators,rxjs,core,overlay,common,icon) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NxPopoverTriggerDirective = /** @class */ (function () {
        ...
        NxPopoverTriggerDirective.propDecorators = {
            ...
            onMouseExit: [{ type: core.HostListener, args: ['mouseleave',] }, { type: core.HostListener, args: ['touchstart',] }]
        };
    ...
    var NxPopoverComponent = /** @class */ (function () {
        ...
        NxPopoverComponent.propDecorators = {
            ...
            _lazyContent: [{ type: core.ContentChild, args: [NxPopoverContentDirective,] }],
