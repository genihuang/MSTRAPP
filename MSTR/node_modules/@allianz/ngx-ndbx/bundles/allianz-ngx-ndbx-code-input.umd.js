(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('rxjs'), require('@angular/core'), require('@angular/forms'), require('@angular/cdk/keycodes')) :
    typeof define === 'function' && define.amd ? define('@allianz/ngx-ndbx/code-input', ['exports', '@angular/common', 'rxjs', '@angular/core', '@angular/forms', '@angular/cdk/keycodes'], factory) :
    (factory((global.allianz = global.allianz || {}, global.allianz['ngx-ndbx'] = global.allianz['ngx-ndbx'] || {}, global.allianz['ngx-ndbx']['code-input'] = {}),global.ng.common,global.rxjs,global.ng.core,global.ng.forms,global.ng.cdk.keycodes));
}(this, (function (exports,common,rxjs,core,forms,keycodes) { 'use strict';
    ...
    var NxCodeInputComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        NxCodeInputComponent.ctorParameters = function () {
            return [
