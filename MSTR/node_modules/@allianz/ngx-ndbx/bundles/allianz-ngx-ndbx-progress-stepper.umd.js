(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@allianz/ngx-ndbx/progressbar'), require('@angular/cdk/coercion'), require('rxjs/operators'), require('@allianz/ngx-ndbx/utils'), require('@angular/core'), require('@angular/common'), require('@allianz/ngx-ndbx/icon'), require('@angular/cdk/stepper')) :
    typeof define === 'function' && define.amd ? define('@allianz/ngx-ndbx/progress-stepper', ['exports', '@allianz/ngx-ndbx/progressbar', '@angular/cdk/coercion', 'rxjs/operators', '@allianz/ngx-ndbx/utils', '@angular/core', '@angular/common', '@allianz/ngx-ndbx/icon', '@angular/cdk/stepper'], factory) :
    (factory((global.allianz = global.allianz || {}, global.allianz['ngx-ndbx'] = global.allianz['ngx-ndbx'] || {}, global.allianz['ngx-ndbx']['progress-stepper'] = {}),global.allianz['ngx-ndbx'].progressbar,global.ng.cdk.coercion,global.rxjs.operators,global.allianz['ngx-ndbx'].utils,global.ng.core,global.ng.common,global.allianz['ngx-ndbx'].icon,global.ng.cdk.stepper));
}(this, (function (exports,progressbar,coercion,operators,utils,core,common,icon,stepper) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NxStepComponent = /** @class */ (function (_super) {
        ...
        function NxStepComponent(stepper$$1, _errorStateMatcher) {
        ...
        NxStepComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        exportAs: 'nxStep',
                        providers: [{ provide: utils.ErrorStateMatcher, useExisting: NxStepComponent }],
                        preserveWhitespaces: false,
                        changeDetection: core.ChangeDetectionStrategy.OnPush
                    }] }
        ];
        /** @nocollapse */
        NxStepComponent.ctorParameters = function () {
            return [
                { type: NxProgressStepperDirective, decorators: [{ type: core.Inject, args: [core.forwardRef(( /**
                                                 * @return {?}
                                                 */function () { return NxProgressStepperDirective; })),] }] },
                { type: utils.ErrorStateMatcher, decorators: [{ type: core.SkipSelf }] }
            ];
        };
    ...
    var NxProgressStepperDirective = /** @class */ (function (_super) {
        ...
        function NxProgressStepperDirective() {
            ...
            _this._stepHeader = new core.QueryList();
            return _this;
        }
        /**
         * @return {?}
        ...
        NxProgressStepperDirective.propDecorators = {
            _steps: [{ type: core.ContentChildren, args: [NxStepComponent,] }],
            currentStepLabel: [{ type: core.Input }],
    ...
    var NxMultiStepItemComponent = /** @class */ (function (_super) {
        ...
        function NxMultiStepItemComponent(_changeDetectorRef, stepper$$1, _errorStateMatcher) {
            var _this = _super.call(this, stepper$$1, _errorStateMatcher) || this;
        ...
        Object.defineProperty(NxMultiStepItemComponent.prototype, "last", {
             ...
             * @param {?} value
             * @return {?}
             */ function (value) { this._last = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(NxMultiStepItemComponent.prototype, "first", {
             ...
             * @param {?} value
             * @return {?}
             */ function (value) { this._first = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(NxMultiStepItemComponent.prototype, "stepCompleted", {
             ...
             * @return {?}
             */ function (value) {
                this._completed = coercion.coerceBooleanProperty(value);
        ...
        /** @nocollapse */
        NxMultiStepItemComponent.ctorParameters = function () {
            return [
    ...
    var NxSingleStepperComponent = /** @class */ (function (_super) {
        ...
        NxSingleStepperComponent.propDecorators = {
            rightLabel: [{ type: core.Input, args: ['nextLabel',] }]
        };
    ...
    var NxProgressStepperComponent = /** @class */ (function (_super) {
        ...
        Object.defineProperty(NxProgressStepperComponent.prototype, "progress", {
             ...
             * @param {?} value
             * @return {?}
             */ function (value) { this._progress = utils.clamp(value || 0); },
            enumerable: true,
            configurable: true
        });
    ...
    var NxStepperNextDirective = /** @class */ (function (_super) {
         ...
         */
            function () {
                /** @type {?} */
                var stepper$$1 = ( /** @type {?} */(this._stepper));
                if (this.disabled !== !stepper$$1.hasNext) {
                    this.disabled = !stepper$$1.hasNext;
        ...
        NxStepperNextDirective.decorators = [
            { type: core.Directive, args: [{
                        ...
                        inputs: ['type'],
                        providers: [{ provide: stepper.CdkStepper, useExisting: NxProgressStepperDirective }]
                    },] }
        ];
        /** @nocollapse */
        NxStepperNextDirective.ctorParameters = function () {
            return [
                { type: stepper.CdkStepper },
                { type: core.ChangeDetectorRef }
            ];
        };
    ...
    var NxStepperPreviousDirective = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        NxStepperPreviousDirective.ctorParameters = function () {
            return [
                { type: stepper.CdkStepper },
                { type: core.ChangeDetectorRef }
            ];
    ...
    exports.NxProgressStepperModule = NxProgressStepperModule;
    exports.NxStepComponent = NxStepComponent;
    exports.NxProgressStepperDirective = NxProgressStepperDirective;
    exports.NxMultiStepperComponent = NxMultiStepperComponent;
    exports.NxMultiStepItemComponent = NxMultiStepItemComponent;
    exports.NxProgressStepperComponent = NxProgressStepperComponent;
    exports.NxSingleStepperComponent = NxSingleStepperComponent;
    exports.NxStepperNextDirective = NxStepperNextDirective;
    exports.NxStepperPreviousDirective = NxStepperPreviousDirective;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=allianz-ngx-ndbx-progress-stepper.umd.js.map