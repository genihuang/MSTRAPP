...
export declare class NxDropdownItemComponent implements Highlightable, OnDestroy, AfterViewChecked {
    private _dropdown;
    /** @docs-private */
    readonly group: NxDropdownGroupComponent;
    ...
    /** @docs-private */
    group: NxDropdownGroupComponent, _changeDetectorRef: ChangeDetectorRef, _elementRef: ElementRef);
    ...
    */
    ...
    /** @docs-private */
    getLabel(): string;
    _isContentEmpty(element: any): boolean;
    _onLabelChange(): void;
}
